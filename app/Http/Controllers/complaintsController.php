...
class complaintsController extends Controller {
	...
	public function export($type){
		...
		$data = array();
		$complaints = \complaints::select('comp_title','comp_desc','comp_type','comp_source','FullName','phoneNo','email','Address','enq_date','nxt_fup','enq_notes')->get()->toArray();
		foreach ($complaints as $value) {
			...
			$data[] = array ($value['comp_title'],$value['comp_desc'],$value['comp_type'],$value['comp_source'],$value['FullName'],$value['phoneNo'],$value['email'],$value['Address'],$value['enq_date'],$value['nxt_fup'],$value['enq_notes']);
		}
