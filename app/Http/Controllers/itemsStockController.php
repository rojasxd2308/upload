...
class itemsStockController extends Controller {
	...
	public function export($type){
		...
		foreach ($items_stock as $value) {
			$value["cat_id"] = (isset($toReturn['inv_cat'][ $value['id'] ])?$toReturn['inv_cat'][ $value['id'] ]:"");
			$value["item_id"] = (isset($toReturn['items_code'][ $value['id'] ])?$toReturn['items_code'][ $value['id'] ]:"");
			$value["store_id"] = (isset($toReturn['stores'][ $value['id'] ])?$toReturn['stores'][ $value['id'] ]:"");
			$value["supplier_id"] = (isset($toReturn['suppliers'][ $value['id'] ])?$toReturn['suppliers'][ $value['id'] ]:"");
		
			$data[] = array ($value['refno'],$value['cat_id'],$value['item_id'],$value['store_id'],$value['supplier_id'],$value['qty'],$value['stock_date'],$value['stock_notes']);
		}
