...
class MediaController extends Controller {
	...
	public function listAlbum()
	{
		...
		if(!$this->panelInit->can( array("mediaCenter.list","mediaCenter.addAlbum","mediaCenter.editAlbum","mediaCenter.delAlbum","mediaCenter.addMedia","mediaCenter.editMedia","mediaCenter.delMedia") )){
			exit;
		}
	...
	public function fetchAlbum($id){
		...
		if(!$this->panelInit->can( array("mediaCenter.editAlbum","mediaCenter.list") )){
			exit;
		}
	...
	function fetch($id){
		...
		if(!$this->panelInit->can( array("mediaCenter.editMedia","mediaCenter.list") )){
			exit;
		}
