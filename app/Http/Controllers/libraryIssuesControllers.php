...
class libraryIssuesControllers extends Controller {
	...
	public function listAll($page = 1,$search = ""){
		...
		$toReturn["library_issue"] = $toReturn["library_issue"]->select('id','issue_id','user_id','book_id','serial_num','issue_date','ret_date','issue_notes')->take('20')->skip(20* ($page - 1) )->get()->toArray();
