...
class enquiriesController extends Controller {
	...
	public function export($type){
		...
		foreach ($enquiries as $value) {
			...
			$data[] = array ($value['enq_title'],$value['enq_desc'],$value['enq_type'],$value['enq_source'],$value['FullName'],$value['phoneNo'],$value['email'],$value['Address'],$value['enq_date'],$value['nxt_fup'],$value['enq_notes']);
		}
