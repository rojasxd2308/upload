...
class DashboardInit {
	...
	public function __construct(){
		$this->panelItems = array(
									...
									"media"=>array("title"=>"mediaCenter","url"=>URL::to('portal#/media'),"role_perm"=>array("mediaCenter.list","mediaCenter.addAlbum","mediaCenter.editAlbum","mediaCenter.delAlbum","mediaCenter.addMedia","mediaCenter.editMedia","mediaCenter.delMedia"),"icon"=>"mdi mdi-folder-multiple-image","activated"=>"mediaAct" ),
